...
def upgrade() -> None:
    ...
    op.alter_column('users', 'subscription_plan',
               existing_type=postgresql.ENUM('free', 'weekly', 'monthly', 'annual', name='subscriptionplantype'),
               type_=sa.String(),
...
def downgrade() -> None:
    ...
    op.alter_column('users', 'subscription_plan',
               ...
               type_=postgresql.ENUM('free', 'weekly', 'monthly', 'annual', name='subscriptionplantype'),
               existing_nullable=False)
    # ### end Alembic commands ###
